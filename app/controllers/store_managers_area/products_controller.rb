...
module StoreManagersArea
  ...
  def create
    ...
    if @product.save
      redirect_to store_managers_area_products_path(slug: @store.slug), notice: "Product created"
    else
    ...
    def update
      if @product.update(product_params)
        redirect_to store_managers_area_products_path(slug: @store.slug), notice: "Product updated"
      else
        render :edit
      end
    end
    ...
    def destroy
      @product.destroy
        redirect_to store_managers_area_products_path(slug: @store.slug), notice: "Product destroyed"
    end
    ...
    def restore
      ...
      redirect_to store_managers_area_products_path, notice: 'Product restored successfully.'
    end
    ...
    def set_product
      ...
      redirect_to store_managers_area_products_path, alert: 'Product not found.' unless @product
    end
